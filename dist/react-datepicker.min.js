!(function(e, t) {
	...
	function L() {
		for (
			...
			} else if ("object" === (void 0 === a ? "undefined" : V(a))) {
				var p = Object.keys(a),
					c = p[0],
					l = a[p[0]];
		...
		X = (function(t) {
			function n() {
				...
				for (var s = arguments.length, i = Array(s), p = 0; s > p; p++)
					i[p] = arguments[p];
				return (
					(r = o = U(this, t.call.apply(t, [this].concat(i)))),
			...
			return (
				(o.renderOptions = function() {
					return o.state.monthYearsList.map(function(t) {
						var n = t.valueOf(),
							r = Y(o.props.date, t) && j(o.props.date, t);
						return e.createElement(
							"div",
							{
								className: r
				...
				(o.state = {
					monthYearsList: (function(e, t) {
						for (var n = [], r = _(h(e)), o = _(h(t)); !x(r, o); )
							n.push(h(r)), E(r, 1);
						return n;
		...
		re = (function(t) {
			function n() {
				...
				return (
					...
					(o.renderReadView = function(t) {
						var n = f(I(d(o.props.date), o.props.locale), o.props.dateFormat);
						return e.createElement(
							"div",
							{
								key: "read",
					...
					(o.onChange = function(e) {
						o.toggleDropdown();
						var t = d(parseInt(e));
						(Y(o.props.date, t) && j(o.props.date, t)) || o.props.onChange(t);
					}),
					(o.toggleDropdown = function() {
						return o.setState({ dropdownVisible: !o.state.dropdownVisible });
					}),
	...
	var oe = (function(t) {
		function r() {
			...
			for (var s = arguments.length, i = Array(s), p = 0; s > p; p++)
				i[p] = arguments[p];
			return (
				(e = o = U(this, t.call.apply(t, [this].concat(i)))),
				...
				(o.isSelectingRangeStart = function() {
					...
					var e = o.props,
						t = e.day,
						n = e.startDate;
					return e.selectsStart ? R(t, e.selectingDate) : R(t, n);
				}),
				(o.isSelectingRangeEnd = function() {
					...
					var e = o.props,
						t = e.day,
						n = e.endDate;
					return e.selectsEnd ? R(t, e.selectingDate) : R(t, n);
				}),
				(o.isRangeStart = function() {
					var e = o.props,
						t = e.startDate;
					return !(!t || !e.endDate) && R(t, e.day);
				}),
				(o.isRangeEnd = function() {
					var e = o.props,
						t = e.endDate;
					return !(!e.startDate || !t) && R(t, e.day);
				}),
				...
				(o.getClassNames = function(e) {
					...
					return n(
							...
							})(o.props.day),
						{
							...
							"react-datepicker__day--today": o.isSameDay(u(o.props.utcOffset)),
	...
	ae.propTypes = { weekNumber: t.number.isRequired, onClick: t.func };
	var se = (function(t) {
		function n() {
			var r, o, a;
			H(this, n);
				...
				(o.renderDays = function() {
					...
					if (o.props.showWeekNumber) {
						var a = o.props.onWeekSelect
							...
							: void 0;
						n.push(
							e.createElement(ae, { key: "W", weekNumber: r, onClick: a })
						);
					}
					return n.concat(
		...
		pe = (function(t) {
			function r() {
				...
				for (var i = arguments.length, p = Array(i), c = 0; i > c; c++)
					p[c] = arguments[c];
				return (
					(o = a = U(this, t.call.apply(t, [this].concat(p)))),
	...
	var ce = (function(t) {
		function n() {
			...
			for (var s = arguments.length, p = Array(s), c = 0; s > c; c++)
				p[c] = arguments[c];
			return (
				(r = o = U(this, t.call.apply(t, [this].concat(p)))),
				(o.handleClick = function(e) {
					((o.props.minTime || o.props.maxTime) && q(e, o.props)) ||
						(o.props.excludeTimes && P(e, o.props.excludeTimes)) ||
						(o.props.includeTimes && !P(e, o.props.includeTimes)) ||
						o.props.onChange(e);
				}),
		...
		ue = (function(t) {
				...
				return (
					...
					(o.getDateInView = function() {
						var e = o.props,
							...
							p = u(a),
							c = r || n || t;
						return c || (s && T(p, s) ? s : i && x(p, i) ? i : p);
					}),
					...
					(o.decreaseMonth = function() {
						o.setState({ date: O(h(o.state.date), 1) }, function() {
							return o.handleMonthChange(o.state.date);
						});
					}),
					(o.handleDayClick = function(e, t) {
					...
					(o.changeMonthYear = function(e) {
						o.setState({ date: y(g(h(o.state.date), v(e)), k(e)) }, function() {
			...
			return (
				...
				(r.prototype.componentWillReceiveProps = function(e) {
					e.preSelection && !R(e.preSelection, this.props.preSelection)
						? this.setState({ date: this.localizeDate(e.preSelection) })
						: e.openToDate &&
							!R(e.openToDate, this.props.openToDate) &&
	...
	ue.propTypes = {
		...
		renderElementBefore: t.node,
		renderElementAfter: t.node
	};
	var he = [
			"auto",
			"auto-left",
		...
		me = (function(t) {
			function r() {
				return H(this, r), U(this, t.apply(this, arguments));
			}
			return (
				z(r, t),
				(r.prototype.render = function() {
	...
	var fe = "react-datepicker-ignore-onclickoutside",
		...
		ge = (function(t) {
			function r(a) {
				...
				return (
					...
					(s.handleChange = function(e) {
						if (
							!s.props.onChangeRaw ||
							(s.props.onChangeRaw(e), !e.isDefaultPrevented())
						) {
							s.setState({ inputValue: e.target.value });
							var t = (function(e, t) {
								var n = o(e, t.dateFormat, t.locale || o.locale(), !0);
								return n.isValid() ? n : null;
							})(e.target.value, s.props);
							(!t && e.target.value) || s.setSelected(t, e, !0);
						}
					}),
					...
					(s.setSelected = function(e, t, n) {
						var r = e;
						(null !== r && W(r, s.props)) ||
							((R(s.props.selected, r) && !s.props.allowSameDay) ||
								(null !== r &&
									(s.props.selected &&
										(r = D(d(r), {
									...
									s.setState({ preSelection: r })),
								s.props.onChange(r, t)),
							s.props.onSelect(r, t),
							n || s.setState({ inputValue: null }));
					}),
					(s.setPreSelection = function(e) {
						(!(void 0 !== s.props.minDate && void 0 !== s.props.maxDate) ||
							!e ||
							F(e, s.props.minDate, s.props.maxDate)) &&
					...
					(s.handleTimeChange = function(e) {
						...
						s.setState({ preSelection: t }), s.props.onChange(t), s.setOpen(!1);
					}),
					...
					(s.renderCalendar = function() {
						return s.props.inline || (s.state.open && !s.props.disabled)
							? e.createElement(
									...
									"renderElementBefore=",
									s.props.renderElementBefore,
									"renderElementAfter=",
									s.props.renderElementAfter,
									s.props.children
								)
							: null;
					}),
					(s.renderDateInput = function() {
						var t,
							r,
							a = n(s.props.className, ((t = {}), (t[fe] = s.state.open), t)),
							i =
								s.props.customInput ||
			...
			return (
				...
				(r.prototype.componentWillReceiveProps = function(e) {
					var t = this.props.selected && v(this.props.selected),
						n = e.selected && v(e.selected);
					this.props.inline && t !== n && this.setPreSelection(e.selected),
						this.props.highlightDates !== e.highlightDates &&
							this.setState({ highlightDates: L(e.highlightDates) });
				}),
	...
	return (
		(ge.propTypes = {
			...
			excludeTimes: t.array,
			useShortMonthInDropdown: t.bool,
			renderElementBefore: e.PropTypes.node,
			renderElementAfter: e.PropTypes.node
		}),
		ge
	);
});
