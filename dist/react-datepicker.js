(function(global, factory) {
	...
	classnames =
		classnames && classnames.hasOwnProperty("default")
			...
			: classnames;
	onClickOutside =
		onClickOutside && onClickOutside.hasOwnProperty("default")
	...
	var supportsProtoAssignment_1 = createCommonjsModule(function(
		module,
		exports
	) {
	...
	typedArrayTags[argsTag$2] = typedArrayTags[arrayTag$1] = typedArrayTags[
		arrayBufferTag$1
	...
	function baseIsEqualDeep(
		...
		if (!(bitmask & COMPARE_PARTIAL_FLAG$1)) {
			var objIsWrapped =
					objIsObj && hasOwnProperty$4.call(object, "__wrapped__"),
	...
	function assignValue(object, key, value) {
		var objValue = object[key];
		if (
			!(hasOwnProperty$10.call(object, key) && eq_1(objValue, value)) ||
	...
	var difference = _baseRest(function(array, values) {
		return isArrayLikeObject_1(array)
			? _baseDifference(
					array,
					_baseFlatten(values, 1, isArrayLikeObject_1, true)
				)
			: [];
	});
	...
	var createPrototypeProxy_1 = createCommonjsModule(function(module, exports) {
		...
		function createPrototypeProxy() {
			...
			proxiedComponentWillUnmount.toString = proxyToString(
			...
			function defineProxyPropertyWithValue(name, value) {
				...
				var enumerable =
					_ref$enumerable === undefined ? false : _ref$enumerable;
	...
	var deleteUnknownAutoBindMethods_1 = createCommonjsModule(function(
		module,
		exports
	) {
		Object.defineProperty(exports, "__esModule", {
	...
	var createClassProxy_1 = createCommonjsModule(function(module, exports) {
		...
		var _deleteUnknownAutoBindMethods2 = _interopRequireDefault(
			deleteUnknownAutoBindMethods_1
		);

		var _supportsProtoAssignment2 = _interopRequireDefault(
			supportsProtoAssignment_1
		);
		...
		function proxyClass(InitialComponent) {
			...
			function wasStaticModifiedByUser(key) {
				...
				var currentDescriptor = Object.getOwnPropertyDescriptor(
					ProxyComponent,
					key
				);
			...
			try {
				...
				ProxyComponent = new Function(
					...
					"instantiate",
					"return function " +
						(InitialComponent.name || "ProxyComponent") +
			...
			function update(NextComponent) {
				...
				ProxyComponent.displayName =
					NextComponent.displayName || NextComponent.name;
		...
		function createClassProxy(Component) {
			return Component.__proto__ && _supportsProtoAssignment2.default()
	...
	var lib = createCommonjsModule(function(module, exports) {
		...
		if (_globalWindow2["default"].__reactComponentProxies) {
			...
			Object.defineProperty(
				_globalWindow2["default"],
				"__reactComponentProxies",
				{
					configurable: true,
					enumerable: false,
					writable: false,
		...
		function proxyReactComponents(_ref) {
			...
			if (
				...
				hot.accept(function(err) {
					if (err) {
						console.warn(
							"[React Transform HMR] There was an error updating " +
								filename +
								":"
						);
						console.error(err);
			...
			return function wrapWithProxy(ReactClass, uniqueId) {
				...
				var _components$uniqueId$isInFunction =
					_components$uniqueId.isInFunction;
				var isInFunction =
					_components$uniqueId$isInFunction === undefined
						? false
						: _components$uniqueId$isInFunction;
				var _components$uniqueId$displayName = _components$uniqueId.displayName;
				var displayName =
					_components$uniqueId$displayName === undefined
						? uniqueId
						: _components$uniqueId$displayName;
	...
	var _reactTransformHmr2$3 = _reactTransformHmr({
		filename:
			"/Users/iuri/Projects/react-datepicker/src/year_dropdown_options.jsx",
	...
	var YearDropdownOptions = _wrapComponent$3("YearDropdownOptions")(
		((_temp$2 = _class$3 = (function(_React$Component) {
	...
	var _reactTransformHmr2$2 = _reactTransformHmr({
		filename: "/Users/iuri/Projects/react-datepicker/src/year_dropdown.jsx",
	...
	var YearDropdown = _wrapComponent$2("YearDropdown")(
		((_temp2 = _class$2 = (function(_React$Component) {
	...
	var _reactTransformHmr2$5 = _reactTransformHmr({
		filename:
			"/Users/iuri/Projects/react-datepicker/src/month_dropdown_options.jsx",
	...
	var MonthDropdownOptions = _wrapComponent$5("MonthDropdownOptions")(
		((_temp2$2 = _class$5 = (function(_React$Component) {
	...
	var _reactTransformHmr2$4 = _reactTransformHmr({
		filename: "/Users/iuri/Projects/react-datepicker/src/month_dropdown.jsx",
	...
	var MonthDropdown = _wrapComponent$4("MonthDropdown")(
		((_temp2$1 = _class$4 = (function(_React$Component) {
	...
	var _components$7 = {
		MonthYearDropdownOptions: {
			displayName: "MonthYearDropdownOptions"
		}
	};

	var _reactTransformHmr2$7 = _reactTransformHmr({
		filename:
			"/Users/iuri/Projects/react-datepicker/src/month_year_dropdown_options.jsx",
	...
	var MonthYearDropdownOptions = _wrapComponent$7("MonthYearDropdownOptions")(
		((_temp$3 = _class$7 = (function(_React$Component) {
	...
	var _reactTransformHmr2$6 = _reactTransformHmr({
		filename:
			"/Users/iuri/Projects/react-datepicker/src/month_year_dropdown.jsx",
	...
	var WrappedMonthYearDropdownOptions = onClickOutside(
		MonthYearDropdownOptions
	);

	var MonthYearDropdown = _wrapComponent$6("MonthYearDropdown")(
		((_temp2$3 = _class$6 = (function(_React$Component) {
			...
			function MonthYearDropdown() {
				...
				return (
					...
					(_this.renderSelectOptions = function() {
						var currDate = getStartOfMonth(
							localizeDate(_this.props.minDate, _this.props.locale)
						);
						var lastDate = getStartOfMonth(
							localizeDate(_this.props.maxDate, _this.props.locale)
						);
					...
					(_this.renderReadView = function(visible) {
						var yearMonth = formatDate(
							localizeDate(newDate(_this.props.date), _this.props.locale),
	...
	var _reactTransformHmr2$10 = _reactTransformHmr({
		filename: "/Users/iuri/Projects/react-datepicker/src/day.jsx",
	...
	var Day = _wrapComponent$10("Day")(
		((_temp2$6 = _class$10 = (function(_React$Component) {
	...
	var _reactTransformHmr2$11 = _reactTransformHmr({
		filename: "/Users/iuri/Projects/react-datepicker/src/week_number.jsx",
	...
	var WeekNumber = _wrapComponent$11("WeekNumber")(
		((_temp2$7 = _class$11 = (function(_React$Component) {
	...
	var _reactTransformHmr2$9 = _reactTransformHmr({
		filename: "/Users/iuri/Projects/react-datepicker/src/week.jsx",
	...
	var Week = _wrapComponent$9("Week")(
		((_temp2$5 = _class$9 = (function(_React$Component) {
	...
	var _reactTransformHmr2$8 = _reactTransformHmr({
		filename: "/Users/iuri/Projects/react-datepicker/src/month.jsx",
	...
	var Month = _wrapComponent$8("Month")(
		((_temp2$4 = _class$8 = (function(_React$Component) {
				...
				return (
					...
					(_this.renderWeeks = function() {
						...
						var currentWeekStart = getStartOfWeek(
							getStartOfMonth(cloneDate(_this.props.day))
						);
						var i = 0;
	...
	var _reactTransformHmr2$12 = _reactTransformHmr({
		filename: "/Users/iuri/Projects/react-datepicker/src/time.jsx",
		components: _components$12,
		locals: [module],
		imports: [React]
	});

	function _wrapComponent$12(id) {
		return function(Component) {
			return _reactTransformHmr2$12(Component, id);
		};
	}

	var Time = _wrapComponent$12("Time")(
		((_temp2$8 = _class$12 = (function(_React$Component) {
	...
	var _reactTransformHmr2$1 = _reactTransformHmr({
		filename: "/Users/iuri/Projects/react-datepicker/src/calendar.jsx",
	...
	var Calendar = _wrapComponent$1("Calendar")(
		((_temp$1 = _class$1 = (function(_React$Component) {
			...
			function Calendar(props) {
				...
				_this.changeMonthYear = function(monthYear) {
					_this.setState(
						{
							date: setYear(
								setMonth(cloneDate(_this.state.date), getMonth(monthYear)),
								getYear(monthYear)
							)
						},
						function() {
				...
				_this.renderPreviousMonthButton = function() {
					var allPrevDaysDisabled = allDaysDisabledBefore(
						_this.state.date,
						"month",
						_this.props
					);
				...
				_this.renderNextMonthButton = function() {
					var allNextDaysDisabled = allDaysDisabledAfter(
						_this.state.date,
						"month",
						_this.props
					);
						...
						"div",
						{
							...
							onClick: function onClick(e) {
								return _this.props.onSelect(
									getStartOfDate(now(_this.props.utcOffset)),
									e
								);
							}
						},
	...
	var _reactTransformHmr2$13 = _reactTransformHmr({
		filename: "/Users/iuri/Projects/react-datepicker/src/popper_component.jsx",
		components: _components$13,
		locals: [module],
		imports: [React]
	});

	function _wrapComponent$13(id) {
		return function(Component) {
			return _reactTransformHmr2$13(Component, id);
		};
	}
	...
	var PopperComponent = _wrapComponent$13("PopperComponent")(
		((_temp$4 = _class$13 = (function(_React$Component) {
	...
	var _reactTransformHmr2 = _reactTransformHmr({
		filename: "/Users/iuri/Projects/react-datepicker/src/index.jsx",
	...
	var DatePicker = _wrapComponent("DatePicker")(
			...
			function DatePicker(props) {
				...
				_this.getPreSelection = function() {
					return _this.props.openToDate
						...
						: _this.props.selectsEnd && _this.props.startDate
							? newDate(_this.props.startDate)
							: _this.props.selectsStart && _this.props.endDate
								? newDate(_this.props.endDate)
								: now(_this.props.utcOffset);
				};
				...
				_this.onInputKeyDown = function(event) {
					...
					if (eventKey === "Enter") {
						event.preventDefault();
						if (
							isMoment(_this.state.preSelection) ||
				...
				_this.renderCalendar = function() {
					...
					return React.createElement(
						WrappedCalendar,
						{
							...
							yearDropdownItemNumber: _this.props.yearDropdownItemNumber,
							renderElementBefore: _this.props.renderElementBefore,
							renderElementAfter: _this.props.renderElementAfter
						},
